...
export const useShopStore = create(
	persist(
		(set, get) => ({
			...
			addBadge: (badge) => set((state) => ({ selectedBadges: [...state.selectedBadges, badge] })),
			removeBadge: (badgeName) => set((state) => ({ selectedBadges: state.selectedBadges.filter(b => b !== badgeName) })),
			// Theme
