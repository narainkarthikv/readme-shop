...
const Footer = React.memo(() => (
  <BottomNavigation
    ...
    sx={(theme) => ({
      ...
      alignItems: 'center',
      p: 2,
      bgcolor: theme.palette.mode === 'dark' ? '#008cffff' : theme.palette.primary.main,
      color: theme.palette.mode === 'dark' ? theme.palette.text.primary : 'white',
      width: '100%',
      borderTop: `1px solid ${theme.palette.divider}`,
      fontSize: { xs: '0.85rem', sm: '1rem' },
      minHeight: 56,
      boxShadow: theme.palette.mode === 'dark' ? '0 -2px 8px rgba(0,0,0,0.15)' : 'none',
      transition: 'background 0.3s',
    })}
  >
    <Typography sx={{ fontWeight: 100, textAlign: 'center', width: '100%' }} variant="body2">
